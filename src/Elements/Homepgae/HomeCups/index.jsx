...
const HomeCupsSection = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [isModalVisible, setIsModalVisible] = useState(false);
  const [selectedFlavour, setSelectedFlavour] = useState(null);

  const flavours = [
    { name: 'Mango', img: '/cup10.png', description: '' },
    { name: 'StrawBerry', img: '/cup11.png', description: '' },
    { name: 'Vanilla', img: '/cup12.png', description: '' },
    { name: 'StrawBerry', img: '/cup13.png', description: '' },
    { name: 'Butter', img: '/cup14.png', description: '' },
    { name: 'Chocolate', img: '/cup15.png', description: '' },
    { name: 'Vanilla', img: '/cup16.png', description: '' },
     { name: 'Mango', img: '/cup10.png', description: '' },
    { name: 'StrawBerry', img: '/cup11.png', description: '' },
    { name: 'Vanilla', img: '/cup12.png', description: '' },
  ...
  return (
    <div className="container mx-auto px-2 py-3 relative">
      ...
      <Carousel
        ...
        prevArrow={<PrevArrow />}
        autoplay
        autoplaySpeed={2100} // Set autoplay speed to 1.5 seconds
        dots={false}
...
export default HomeCupsSection;
