...
const HomeConesSection = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [isModalVisible, setIsModalVisible] = useState(false);
  const [selectedFlavour, setSelectedFlavour] = useState(null);

  const flavours = [
    { name: 'ButterScotch', img: '/cone31.png', description: '' },
    { name: 'Vanilla', img: '/cone32.png', description: '' },
    { name: 'Coconut', img: '/cone33.png', description: '' },
    { name: 'Rajbhog Cone', img: '/cone34.png', description: '' },
    { name: 'StrawBerry', img: '/cone35.png', description: '' },
    { name: 'Chocolate', img: '/cone36.png', description: '' },
    { name: 'Twin cone', img: '/cone37.png', description: '' },
    { name: 'Oreo', img: '/cone38.png', description: '' },
    { name: 'Rabari Cone', img: '/cone39.png', description: '' },
    { name: 'Chocolate', img: '/cone40.png', description: '' },
  ...
  return (
    <div className="container mx-auto px-2 py-3 relative">
      ...
      <Carousel
        ...
        prevArrow={<PrevArrow />}
        autoplay
        autoplaySpeed={2000} // Set autoplay speed to 1.5 seconds
        dots={false}
...
export default HomeConesSection;
